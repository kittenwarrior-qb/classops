...
export type DemoClass = { id: string; name: string; schedule: string; branch: string; teacher: string; studentIds: string[] }
export type DemoAttendance = { classId: string; date: string; absentIds: string[] }
...
export const demoClasses: DemoClass[] = [
  { id: 'lh-01', name: 'Lớp nhảy cơ bản', schedule: 'thứ 2 & 4 · 18h30', branch: 'Chi nhánh 1', teacher: 'Thầy giáo 1', studentIds: ['hv-001', 'hv-002', 'hv-003', 'hv-004', 'hv-005', 'hv-006'] },
  { id: 'lh-02', name: 'Lớp nhảy nâng cao', schedule: 'thứ 2 & 4 · 19h45', branch: 'Chi nhánh 1', teacher: 'Thầy giáo 1', studentIds: ['hv-007', 'hv-008', 'hv-009', 'hv-010'] },
]
